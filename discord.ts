...
export async function send(item: { name: string, canonical_url: string, image_url: string, template_key: string, timestamp: number, baseline_raw: string, id: number, sites: string[] }) {
    try {
        let sites: string[] = [];
